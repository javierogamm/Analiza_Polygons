...
La app carga Leaflet y Leaflet.draw de forma programática y muestra un mensaje si hubiera un problema de red al obtenerlos. Una vez que el mapa aparece, las teselas de OpenStreetMap se reajustan automáticamente al contenedor visible.
