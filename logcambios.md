...
## v1.3.2
- Solución al error de sintaxis en `main.js` envolviendo la lógica en una IIFE sin módulo para evitar retornos ilegales.
- Se mantiene la carga estable del mapa y la exportación de coordenadas para múltiples puntos y polígonos.

## v1.3.3
- Restablecida la lógica del mapa a la versión estable previa a la envoltura en IIFE para eliminar el error de `return` ilegal.
- El mapa vuelve a renderizar correctamente las teselas de OpenStreetMap y las herramientas de dibujo.
